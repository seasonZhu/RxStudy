...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HttpRequest/HttpRequest.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxStudyUtils/RxStudyUtils.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftUIExample/SwiftUIExample.framework"
fi
