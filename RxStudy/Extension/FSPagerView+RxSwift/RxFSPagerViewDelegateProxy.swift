...
//  将FSPagerViewDelegate做Rx封装,这种封装真的是累啊,而且容易出错,吃力不讨好,我也不想在封装第二个了,我放弃治疗了
...
//
//@MainActor
//extension FSPagerView: @retroactive HasDelegate {
...
//    , DelegateProxyType
//, @preconcurrency FSPagerViewDelegate {
//    
//    /// Typed parent object.
...
//    }
//    
//        @MainActor public func pagerView(_ pagerView: FSPagerView, didSelectItemAt index: Int) {
//        
//        if let subject = _pagerViewDidSelectItemAtPublishSubject {
//            subject.on(.next(index))
//        }
...
//    }
//    
//    @MainActor public func pagerView(_ pagerView: FSPagerView, willDisplay cell: FSPagerViewCell, forItemAt index: Int) {
//        
//        if let subject = _pagerViewWillDisplayPublishSubject {
