...
extension MyViewModel {
    static let logoutDataSource: [My] = [.myGitHub, .myJueJin, .aSwiftUI, .aUniApp, .openSource, .tools, .course, .ranking, .login]
    
    static let loginDataSource: [My] = [.myGitHub, .myJueJin, .aSwiftUI, .aUniApp, .openSource, .tools, .course, .ranking, .myCoin, .myCollect, .myMessage, .logout]
}
