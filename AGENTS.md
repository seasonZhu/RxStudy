...
graph TD
    ...
    click B1 "./RxStudy/Account/AGENTS.md" "查看 Account 模块文档"
    click B4 "./RxStudy/Home/AGENTS.md" "查看 Home 模块文档"
    click B6 "./RxStudy/My/AGENTS.md" "查看 My 模块文档"
    click B7 "./RxStudy/SwiftUIExample/AGENTS.md" "查看 SwiftUIExample 模块文档"
    click B8 "./RxStudy/Tabs/AGENTS.md" "查看 Tabs 模块文档"
    click C2 "./Packages/HttpRequest/AGENTS.md" "查看 HttpRequest 模块文档"
```
...
### 2026-03-24 (续)
- **更新**: 根级 `AGENTS.md` 新增 SwiftUIApp Target 完整信息
